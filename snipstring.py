#developer SOMRAJ GAUTAM (IIT Dhanbad)
import io
import os
import sys
...
def processImage(img):
    ...
    if result:
        ...
        print(f'INFO: Copied "{result}" to the the given txt file')
...
def notify(msg):
    try:
        Notification(title="Snappa", description=msg).send()
        ...
        trayicon.show()
        trayicon.showMessage("Snappa", msg, QtWidgets.QSystemTrayIcon.NoIcon)
        trayicon.hide()
